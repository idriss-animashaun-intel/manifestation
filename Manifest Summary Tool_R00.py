...
manifest_tool_directory = manifest_tool_master_directory+"\manifest-summary-toolkit-updates"
...
def installation():
    ...
    urllib.request.urlretrieve("https://gitlab.devtools.intel.com/ianimash/manifest-summary-toolkit/-/archive/updates/manifest-summary-toolkit-updates.zip", manifest_tool_master_directory+"\\manifest_tool_new.zip")
...
if os.path.isfile(manifest_tool_file):
    ...
    f = urllib.request.urlopen("https://gitlab.devtools.intel.com/ianimash/manifest-summary-toolkit/raw/updates/main.exe") # points to the exe file for size
    i = f.info()
